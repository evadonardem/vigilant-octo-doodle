...
export default class StockCards extends Component {
    constructor(props) {
        super(props);
        this.handleCloseDeleteStockCardModal = this.handleCloseDeleteStockCardModal.bind(this);
        this.handleSubmitDeleteStockCardModal = this.handleSubmitDeleteStockCardModal.bind(this);

        this.state = {
            token: '',
            stockCardDeleteModal: {
                show: false,
                stockCardId: null,
            },
        };
    ...
    handleCloseDeleteStockCardModal(e) {
        const self = this;
        self.setState({
            ...self.state,
            stockCardDeleteModal: {
    ...
    handleSubmitDeleteStockCardModal(e) {
        e.preventDefault();

        const self = this;
        const { token, stockCardDeleteModal } = self.state;
        ...
        return (
            <div className="container-fluid my-4">
                ...
                <CommonDeleteModal
                    ...
                    handleClose={this.handleCloseDeleteStockCardModal}
                    handleSubmit={this.handleSubmitDeleteStockCardModal}/>
            </div>
        );
    }
}
